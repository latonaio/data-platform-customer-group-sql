LOCK TABLES `data_platform_customer_group_customer_group_text_data` WRITE;

INSERT INTO `data_platform_customer_group_customer_group_text_data` (`CustomerGroup`, `Language`, `CustomerGroupName`)
VALUES
	('01', 'JA', '農業');
	('02', 'JA', '林業');
	('03', 'JA', '漁業');
